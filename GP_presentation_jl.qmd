...
Polynomial regression extends simple linear regression by allowing for more flexible relationships between the independent and dependent variables. It does this by adding higher-order terms (squares, cubes, etc.) of the predictor variables in the regression equation.
